...
const (
	RaftService_RequestVote_FullMethodName   = "/main.RaftService/RequestVote"
	RaftService_AppendEntries_FullMethodName = "/main.RaftService/AppendEntries"
)
...
type RaftServiceClient interface {
	RequestVote(ctx context.Context, in *RequestVoteMessage, opts ...grpc.CallOption) (*RequestVoteReply, error)
	AppendEntries(ctx context.Context, in *AppendEntriesMessage, opts ...grpc.CallOption) (*AppendEntriesReply, error)
}
...
func (c *raftServiceClient) RequestVote(ctx context.Context, in *RequestVoteMessage, opts ...grpc.CallOption) (*RequestVoteReply, error) {
...
func (c *raftServiceClient) AppendEntries(ctx context.Context, in *AppendEntriesMessage, opts ...grpc.CallOption) (*AppendEntriesReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RaftServiceServer interface {
	RequestVote(context.Context, *RequestVoteMessage) (*RequestVoteReply, error)
	AppendEntries(context.Context, *AppendEntriesMessage) (*AppendEntriesReply, error)
...
func (UnimplementedRaftServiceServer) RequestVote(context.Context, *RequestVoteMessage) (*RequestVoteReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestVote not implemented")
}
func (UnimplementedRaftServiceServer) AppendEntries(context.Context, *AppendEntriesMessage) (*AppendEntriesReply, error) {
...
func _RaftService_AppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RaftServiceServer).AppendEntries(ctx, req.(*AppendEntriesMessage))
	}
	return interceptor(ctx, in, info, handler)
}
